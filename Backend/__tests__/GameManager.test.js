...
describe("GameManager", () => {
  ...
  it("generateQuestions returns correct questions", async () => {
    ...
    jest
      .spyOn(QuestionGenerator.prototype, "getNumArr")
      .mockImplementation(() => {
        return [1, 1];
      });
    jest
      .spyOn(QuestionGenerator.prototype, "getQuestions")
      .mockImplementation(() => {
  ...
  it("generateQuestions returns correct questions and requests random questions when we do not have enough questions", async () => {
    ...
    expect(result).toEqual(0);
    expect(room.gameQuestions).toEqual([
      "Question 1",
      "Question 1",
      "Question 1",
    ]);
  ...
  it("addResponseToRoom should add a player action to the room", () => {
    ...
    const pAction = new PlayerAction("user1", 1000, true, 0, "");
